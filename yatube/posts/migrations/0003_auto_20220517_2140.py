# Generated by Django 2.2.9 on 2022-05-17 21:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='description',
            field=models.TextField(max_length=1000, verbose_name='Описание группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(unique=True, verbose_name='Название ссылки группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
